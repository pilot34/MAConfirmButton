...
- (void)toggle{
  ...
  if(_disabled){
    ...
    colorAnimation.fromValue = selected ? (id)_tint.CGColor : (id)greenColor.CGColor;
    colorAnimation.toValue = selected ? (id)greenColor.CGColor : (id)_tint.CGColor;
  }
...
- (void)setupLayers{
  ...
  bevelLayer.colors = @[(id)[UIColor colorWithWhite:0 alpha:0.5].CGColor, (id)([UIColor whiteColor].CGColor)];
  ...
  colorGradient.colors = @[(id)[UIColor colorWithWhite:1 alpha:0.1].CGColor, (id)([UIColor colorWithWhite:0.2 alpha:0.1].CGColor)];		
  colorGradient.locations = @[@0.0f, @1.0f];		
...
- (void)touchesEnded:(NSSet *)touches withEvent:(UIEvent *)event{
  ...
  if(!_disabled && !confirmed){
    ...
    }else if(selected || !self.confirm){
      [self lighten];
      confirmed = self.confirm != nil;
